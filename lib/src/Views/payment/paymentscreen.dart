...
class PaymentScreen extends StatefulWidget {
  ...
  FirebaseUser user;
  Firestore _db;
  PaymentScreen(this._auth, this.user, this._db);
  @override
...
class _PaymentScreenState extends State<PaymentScreen> {
  ...
  void initState() {
    StripePayment.setOptions(StripeOptions(
        publishableKey:
            "pk_test_51GzJm8LlTCGQsQVIfc7l1x4Cf4QM4GX4jxKSxX3WdAZsiLJH5nRiskSMfombF1xgKquF8gPz5peMfpoBNaJ9psEP00i1rSNZtH")); // TODO: Add Publishable Key
    super.initState();
  }
  ...
  startPaymentProcess() {
    StripePayment.paymentRequestWithCardForm(CardFormPaymentRequest())
      ...
      callable
          .call(<String, dynamic>{'amount': amount * 100.0, 'currency': 'usd'}).then(
              (response) {
