...
class MathHighScreen extends StatefulWidget {
  @override
  _MathHighScreenState createState() => _MathHighScreenState();
}

class _MathHighScreenState extends State<MathHighScreen> {
  final maxLines = 5;
  String message = '';
  String helper = '';
  bool loading = false;
                        ...
                        Container(
                          child: Row(children: <Widget>[
                            ResponsiveContainer(
                              ...
                              child: Image.asset(
                                "assets/images/title/math-highTitle.png",
                              ),
                              widthPercent: 50.0,
                              heightPercent: 25,
                            ),
